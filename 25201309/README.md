# 25201309
# Machine Learning Practical Lab
...
The dataset contains only numerical features, so feature scaling was applied to improve model convergence.
Exploratory data analysis was performed to understand class distribution and feature relationships.
...
The regularization parameter C was tuned to balance margin maximization and misclassification error. F1-score was used as the evaluation metric to balance precision and recall in a medical diagnosis context.
